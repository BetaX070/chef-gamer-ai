...
st.caption("Ask me absolutely anything about code, embedded systems, or architecture!")

# Connect to Groq using the Secret Safe
client = Groq(api_key=st.secrets["GROQ_API_KEY"])

# The Open Brain Instruction (FIXED WITH TRIPLE QUOTES)
system_prompt = """
...
if prompt := st.chat_input("Ask me a coding or hardware question..."):
